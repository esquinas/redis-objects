...
* Update specs, Ruby versions and changelog

* Merge pull request #1 from esquinas/change_exists Change Redis#exists to Redis#exists? [Enrique Esquinas]

* Change Redis#exists to Redis#exists? * bump redis version to 4.2

* use redis.exists? instead of redis.exists [Alina Hryshchuk]
